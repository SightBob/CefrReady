        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="/" className="text-slate-600 hover:text-primary-600 transition-colors font-medium">
                Home
              </Link>
              <Link href="/tests" className="text-slate-600 hover:text-primary-600 transition-colors font-medium">
                Tests
              </Link>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 animate-slide-up">
            ...
            <div className="text-center mb-6">
              <div className="inline-flex bg-gradient-to-br from-primary-500 to-accent-500 p-3 rounded-xl mb-4">
              ...
              <p className="text-slate-500 mt-1">
                {authMode === 'login' ? 'Sign in to continue learning' : 'Start your learning journey'}
              </p>
            </div>
