  ...
  try {
    ...
    if (listeningId) {
      ...
      await db.execute(sql`
        ...
        VALUES
          (${listeningId}, 'When is the meeting?', 'This morning', 'At 3 PM', 'In Conference Room A', 'Tomorrow', 'B', 'The speaker says the meeting has been rescheduled to 3 PM.', 'A2', 'easy', 'true',
          ...
          (${listeningId}, 'Where is the package?', 'At the post office', 'In the mailbox', 'At the front desk', 'With the delivery person', 'C', 'The speaker says the package has been delivered to the front desk.', 'A2', 'easy', 'true',
